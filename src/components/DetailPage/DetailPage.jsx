  ...
  return (
    <>
      <div className="movie_card" id="tomb">
        <div className="info_section">
          <div className="movie_header">
            ...
            <span className="minutes">{movieDetails.Runtime  !== 'N/A' ? movieDetails.Runtime : 'Unknown'}</span>
          ...
          <div className="movie_desc">
            ...
            <p className="text">
              <h4>{`Director: ${movieDetails.Director  !== 'N/A' ? movieDetails.Director : 'No Name'}`}</h4>
            </p>
            <p className="text">
              <span className="minutes">{`Ratings: ${movieDetails.imdbRating  !== 'N/A' ? movieDetails.imdbRating : 'No Rating'}`}</span>
            </p>
          </div>
          <div className="movie_actor">
            <ul>
              <li><i>{`Actors: ${movieDetails.Actors !== 'N/A' ? movieDetails.Actors : 'No Name'}`}</i></li>
            </ul>
          </div>
        </div>
      ...
      <div className="back-button">
        <Button type="dashed" onClick={handleBackClick} >Back to Search</Button>
      </div>
    </>
  );
};
